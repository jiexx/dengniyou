        ...
        WebIMWidget.init({
            ...
            onSuccess: function (id) {
                ...
                if(msg && msg.trim()!='' && msg != undefined && msg != 'undefined'){
                    if(msg.indexOf('D') > -1) {
                        $scope.conversation.messageContent = '咨询方案链接: http://mall.dengniyou.com:808/#/plandetail?PlanID='+msg.substring(1);
                    }else {
                        $scope.conversation.messageContent = '请帮忙定制方案链接: http://mall.dengniyou.com:808/#/templateplandetail?version=2&PlanID='+msg;
                    }
                }
